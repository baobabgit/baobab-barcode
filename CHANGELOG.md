...
- Dépendances : `python-barcode`, `Pillow` ; backend `Code128PngBarcodeGenerator` et `create_default_barcode_generator_registry` ; export du sous-package `infrastructure`.
