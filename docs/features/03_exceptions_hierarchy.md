# 03_exceptions_hierarchy

## Branche
`feature/exceptions-hierarchy`

## Objectif
Crée une hiérarchie d’exceptions spécifique au projet `baobab-barcode`. Prévois une exception racine et des exceptions dédiées pour validation, génération, lecture/décodage, backend indisponible et configuration invalide. Documente les cas de levée, ajoute les tests unitaires associés et remplace les erreurs génériques exposées publiquement.
