# 12_release_readiness

## Branche
`feature/release-readiness`

## Objectif
Prépare la première release technique de la librairie : finalise le `CHANGELOG.md`, vérifie la version SemVer initiale, peaufine la documentation, contrôle l’installation wheel/editable, nettoie les derniers détails de packaging et consigne les travaux dans `docs/dev_diary.md`. Aucun changement de périmètre fonctionnel n’est attendu, uniquement de la stabilisation.
